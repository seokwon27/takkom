    ...
    <footer className="flex flex-col w-full mx-auto items-center justify-center gap-2.5 relative bg-[#f7f9fa] max-sm:hidden">
      <div className="flex flex-col w-full max-w-[1200px] max-h-[480px] items-start gap-12 p-10 relative bg-[#f7f9fa]">
        <div className="flex items-start justify-between relative self-stretch w-full flex-[0_0_auto]">
          ...
          <div className="w-full max-w-[568px] min-w-[400px] inline-flex justify-between items-start relative flex-[0_0_auto]">
            {/* Information */}
        ...
        <div className="flex flex-col items-start gap-6 relative self-stretch w-full flex-[0_0_auto]">
          <div className="flex flex-col items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
            <p className="flex items-center gap-4 relative self-stretch w-full flex-[0_0_auto] line-clamp-2">
              <span className="w-fit mt-[-1.00px] font-label-XL font-[number:var(--label-XL-font-weight)] text-gray-600 text-[length:var(--label-XL-font-size)] leading-[var(--label-XL-line-height)] whitespace-nowrap relative tracking-[var(--label-XL-letter-spacing)] [font-style:var(--label-XL-font-style)]">
                (주)따꼼 컴퍼니
              </span>
